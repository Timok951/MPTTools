...
urlpatterns = [
    ...
    path("warehouse/restock/", views.warehouse_restock, name="warehouse_restock"),
    ...
    path("equipment/public/<int:equipment_id>/", views.equipment_public_card, name="equipment_public_card"),
    path("equipment/<int:equipment_id>/", views.equipment_detail, name="equipment_detail"),
    path("equipment/<int:equipment_id>/split-repair/", views.equipment_split_repair, name="equipment_split_repair"),
    ...
    path(
        "requests/<int:request_id>/equipment-condition/",
        views.request_update_equipment_condition,
        name="request_update_equipment_condition",
    ),
